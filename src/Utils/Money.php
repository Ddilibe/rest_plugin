...
class Money
{
     ...
     */
    public static function cison_get_annual_dues_product_ids($year)
    {
        $year = (int) $year;
    ...
    public static function cison_get_annual_dues_product_ids_till_2025($year)
    {
        $year = (int) $year;
    ...
    public static function cison_get_dev_levy_product_ids($year)
    {
        $year = (int) $year;
    ...
    public static function cison_get_dev_levy_product_ids_till_2025($year)
    {
        $year = (int) $year;
    ...
    public static function cison_get_paid_fees($user_id)
    {
        $user_id = (int) $user_id;
        if ($user_id <= 0) {
            return [];
        ...
        $required_fees = Money::cison_get_required_fees($is_transiting, $reg_year);
    ...
    public static function cison_get_paid_fees_till_2025($user_id)
    {
        $user_id = (int) $user_id;
        if ($user_id <= 0) {
            return [];
     ...
     *   ]
     */
    public static function cison_get_required_fees($is_transiting, $reg_year)
    {
        ...
        if ($is_transiting) {
            ...
            for ($year = 2024; $year <= $current_year; $year++) {
                ...
                $annual_ids = Money::cison_get_annual_dues_product_ids($year);
                if (!empty($annual_ids)) {
                ...
                $dev_ids = Money::cison_get_dev_levy_product_ids($year);
                if (!empty($dev_ids)) {
        ...
        for ($year = $reg_year; $year <= $current_year; $year++) {
            $required["annual_dues_{$year}"] = [
                'name' => "{$year} Annual Dues/Subscription",
                'product_ids' => Money::cison_get_annual_dues_product_ids($year),
            ];

            $required["dev_levy_{$year}"] = [
                'name' => "{$year} Development Levy",
                'product_ids' => Money::cison_get_dev_levy_product_ids($year),
    ...
    public static function cison_get_required_fees_till_2025($is_transiting, $reg_year)
    {
        ...
        if ($is_transiting) {
            ...
            for ($year = 2024; $year <= $current_year; $year++) {
                ...
                $annual_ids = Money::cison_get_annual_dues_product_ids_till_2025($year);
                if (!empty($annual_ids)) {
                    $required["annual_dues_{$year}"] = [
                        'name' => "{$year} Annual Dues/Subscription",
                        'product_ids' => $annual_ids,
                ...
                $dev_ids = Money::cison_get_dev_levy_product_ids_till_2025($year);
                if (!empty($dev_ids)) {
                    $required["dev_levy_{$year}"] = [
                        'name' => "{$year} Development Levy",
                        'product_ids' => $dev_ids,
        ...
        for ($year = $reg_year; $year <= $current_year; $year++) {
            $required["annual_dues_{$year}"] = [
                'name' => "{$year} Annual Dues/Subscription",
                'product_ids' => Money::cison_get_annual_dues_product_ids_till_2025($year),
            ];

            $required["dev_levy_{$year}"] = [
                'name' => "{$year} Development Levy",
                'product_ids' => Money::cison_get_dev_levy_product_ids_till_2025($year),
                //'product_ids' => ($year === 2024) ? [368] : [5063],
            ];
        }
     ...
     */
    public static function cison_get_unpaid_fees($required_fees, $paid_fees)
    {
        $unpaid = [];
